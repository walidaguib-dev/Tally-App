...
{
    public class UpdateObservationDtoValidator : AbstractValidator<UpdateObservationCommand>
    {
        private static readonly string[] AllowedTypes =
        [
            .. Enum.GetNames<ObservationType>().Select(x => x.ToLower()),
        ];

        public UpdateObservationDtoValidator()
        {
            ...
            RuleFor(x => x.Dto.Timestamp).NotNull().WithMessage("Timestamp is required.");
